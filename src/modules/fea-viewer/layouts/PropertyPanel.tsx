...
export default function PropertyPanel({ theme, actor, onOpacityChange }) {
    ...
    const { size } = RenderingBackend.getObjectBounds(actor);
        ...
        <div style={{ padding: "10px 15px" }}>
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12 }}>
                <tbody>
                    ...
                    <tr style={rowStyle}><td style={labelStyle}>Bounds size</td><td style={valueStyle}>{fmt(size[0])} × {fmt(size[1])} × {fmt(size[2])}</td></tr>
