        ...
        <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "15px" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                    ...
                    {(selectionMode === "Line" || selectionMode === "Surface") && (
                        <label style={{ display: "flex", alignItems: "center", gap: "4px" }}>
                            <input
                                ...
                                max="90"
                                step="1"
                                value={selectionFeatureAngle}
                                onChange={(e) => {
                                    const value = Math.min(90, Math.max(0, Number(e.target.value)));
                                    if (Number.isFinite(value)) onSelectionFeatureAngleChange?.(value);
                                }}
                                aria-label="Selection feature angle"
                                title="Feature angle used to expand the selected line or surface"
                                style={{ ...selectStyle, width: "52px", boxSizing: "border-box" }}
                            />
