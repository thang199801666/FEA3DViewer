...
export default function MainLayout({ activeModule, onModuleChange }: MainLayoutProps) {
    ...
    return (
        ...
        >
                ...
                >
                    ...
                    >
                        <Scene
                            ...
                            selectionFeatureAngle={settings.selectionFeatureAngle}
                            measurementMode={measurementMode}
                        />
                        {settings.isSplit && (
                            <div
            ...
            <StatusBar
                ...
                selectionFeatureAngle={settings.selectionFeatureAngle}
                onSelectionFeatureAngleChange={(angle) => updateSetting("selectionFeatureAngle", angle)}
            />
