// Mappers/LookupTable.js
// Mô phỏng vtkLookupTable: ánh xạ giá trị scalar -> màu RGB.
// Mặc định là dải cầu vồng HSV Blue -> Red (giống VTK/ParaView).
...
export class LookupTable {
    constructor(options = {}) {
        ...
        // hue 0.6667 (blue) -> 0.0 (red), giống mặc định của VTK
        this.hueRange = options.hueRange ?? [0.6667, 0.0];
        ...
        // Nếu muốn bảng màu tùy chỉnh: mảng [[t, r, g, b], ...] với t từ 0..1
        this.controlPoints = options.controlPoints ?? null;
        this.table = null; // Float32Array numberOfColors * 3
    }
    ...
    /** Đổi số bậc màu (số band). Ít màu + InterpolateScalarsBeforeMapping => contour band kiểu Abaqus. */
    setNumberOfColors(n) {
        this.numberOfColors = Math.max(1, n | 0);
        this.table = null; // buộc build lại
        return this;
    }
    ...
    /** Đặt bảng màu tùy chỉnh, ví dụ: [[0,0,0,1],[0.5,0,1,0],[1,1,0,0]] (blue->green->red) */
    ...
    /** Lấy màu [r,g,b] (0..1) cho 1 giá trị theo range hiện tại. */
    ...
    /**
     * Xuất bảng màu ra Uint8Array RGBA (numberOfColors * 4), dùng để tạo
     * THREE.DataTexture cho chế độ InterpolateScalarsBeforeMapping.
     */
    getUint8Table() {
        if (!this.table) this.build();
        const n = this.numberOfColors;
    ...
    /**
     * Ánh xạ cả DataArray thành Float32Array màu RGB per-vertex,
     * dùng trực tiếp cho attribute 'color' của Three.js.
     * component = -1 nghĩa là dùng magnitude (cho vector).
     */
