// Core/DataSet.js
// Lớp cơ sở cho mọi lưới có hình học (tương đương vtkDataSet).
// Định nghĩa chung: points (Float32Array phẳng) + pointData + cellData.
// PolyData và UnstructuredGrid kế thừa từ đây.
...
export class DataSet extends DataObject {
    constructor() {
        super();
        this.points = new Float32Array(0);   // [x0,y0,z0, x1,y1,z1, ...]
    ...
    /** Lớp con phải override — tổng số cell. */
    getNumberOfCells() { return 0; }
