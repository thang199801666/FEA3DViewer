...
export const CameraMath = {
  ...
  /**
   * Unified dolly/zoom handling for orthographic and perspective cameras.
   * Supports cursor-centered zooming through cursorNDC.
   */
  dolly(state, factor, camera, cursorNDC = null) {
    ...
    if (camera.isOrthographicCamera) {
      ...
      if (cursorNDC) {
        // Cursor-centered zoom in orthographic mode.
